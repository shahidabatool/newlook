...
import questions from '../../assets/canada_questions.json';
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        This mock test contains 24 random questions from all chapters.\nYou need to score at least 18 correct answers to pass.
      </Text>
      <TouchableOpacity 
